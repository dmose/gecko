(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("devtools/client/shared/vendor/react-prop-types"), require("devtools/client/shared/vendor/react"), require("devtools/client/shared/vendor/react-dom-factories"), require("devtools/client/shared/vendor/react-redux"), require("Services"), require("devtools/client/shared/vendor/redux"));
	else if(typeof define === 'function' && define.amd)
		define(["devtools/client/shared/vendor/react-prop-types", "devtools/client/shared/vendor/react", "devtools/client/shared/vendor/react-dom-factories", "devtools/client/shared/vendor/react-redux", "Services", "devtools/client/shared/vendor/redux"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("devtools/client/shared/vendor/react-prop-types"), require("devtools/client/shared/vendor/react"), require("devtools/client/shared/vendor/react-dom-factories"), require("devtools/client/shared/vendor/react-redux"), require("Services"), require("devtools/client/shared/vendor/redux")) : factory(root["devtools/client/shared/vendor/react-prop-types"], root["devtools/client/shared/vendor/react"], root["devtools/client/shared/vendor/react-dom-factories"], root["devtools/client/shared/vendor/react-redux"], root["Services"], root["devtools/client/shared/vendor/redux"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_69__) {
...
const { cleanFunctionName } = __webpack_require__(102);
const { isLongString } = __webpack_require__(23);
const { MODE } = __webpack_require__(6);
...
const { lengthBubble } = __webpack_require__(106);
const {
  interleave,
  getGripType,
  isGrip,
...
const dom = __webpack_require__(2);
const { span } = dom;
const { ModePropType } = __webpack_require__(36);
...
function arrayIterator(props, grip, max) {
  const { Rep } = __webpack_require__(22);
...
const PropRep = __webpack_require__(37);
const { MODE } = __webpack_require__(6);
const { ModePropType } = __webpack_require__(36);
...
const { getValue, nodeHasFullText } = __webpack_require__(79); /* This Source Code Form is subject to the terms of the Mozilla Public
                                                                 * License, v. 2.0. If a copy of the MPL was not distributed with this
                                                                 * file, You can obtain one at <http://mozilla.org/MPL/2.0/>. */
...
const Undefined = __webpack_require__(272);
const Null = __webpack_require__(273);
const StringRep = __webpack_require__(23);
const Number = __webpack_require__(274);
const ArrayRep = __webpack_require__(36);
const Obj = __webpack_require__(275);
const SymbolRep = __webpack_require__(276);
const InfinityRep = __webpack_require__(277);
const NaNRep = __webpack_require__(278);
const Accessor = __webpack_require__(279);

// DOM types (grips)
const Accessible = __webpack_require__(280);
const Attribute = __webpack_require__(281);
const DateTime = __webpack_require__(282);
const Document = __webpack_require__(283);
const DocumentType = __webpack_require__(284);
const Event = __webpack_require__(285);
const Func = __webpack_require__(102);
const PromiseRep = __webpack_require__(286);
const RegExp = __webpack_require__(287);
const StyleSheet = __webpack_require__(288);
const CommentNode = __webpack_require__(289);
const ElementNode = __webpack_require__(290);
const TextNode = __webpack_require__(291);
const ErrorRep = __webpack_require__(104);
const Window = __webpack_require__(292);
const ObjectWithText = __webpack_require__(293);
const ObjectWithURL = __webpack_require__(294);
const GripArray = __webpack_require__(105);
const GripMap = __webpack_require__(107);
const GripMapEntry = __webpack_require__(108);
const Grip = __webpack_require__(77);
...
const { rep: StringRep } = __webpack_require__(23);
...
const { MODE } = __webpack_require__(6);
const { rep } = __webpack_require__(77);
...
const { MODE } = __webpack_require__(6);
const nodeConstants = __webpack_require__(103);
const dom = __webpack_require__(2);
const { span } = dom;
...
const String = __webpack_require__(23).rep;
...
const { createElement, createFactory, PureComponent } = __webpack_require__(1);
const { Provider } = __webpack_require__(5);
const ObjectInspector = createFactory(__webpack_require__(296));
const createStore = __webpack_require__(300);
...
const { Component, createFactory } = __webpack_require__(1);
const dom = __webpack_require__(2);
const { connect } = __webpack_require__(5);
const { bindActionCreators } = __webpack_require__(69);
...
const classnames = __webpack_require__(8);
const { MODE } = __webpack_require__(6);
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators(__webpack_require__(299), dispatch);
}
...
const { loadItemProperties } = __webpack_require__(110); /* This Source Code Form is subject to the terms of the Mozilla Public
                                                                    * License, v. 2.0. If a copy of the MPL was not distributed with this
                                                                    * file, You can obtain one at <http://mozilla.org/MPL/2.0/>. */
...
const { applyMiddleware, createStore, compose } = __webpack_require__(69);
const { thunk } = __webpack_require__(301);
const {
  waitUntilService
} = __webpack_require__(302);
const reducer = __webpack_require__(303);
...
const { MODE } = __webpack_require__(6);
const { REPS, getRep } = __webpack_require__(22);
const ObjectInspector = __webpack_require__(295);
const ObjectInspectorUtils = __webpack_require__(78);
...
const client = __webpack_require__(109);
const loadProperties = __webpack_require__(110);
const node = __webpack_require__(79);
const { nodeIsError, nodeIsPrimitive } = node;
const selection = __webpack_require__(298);
...
const ArrayRep = __webpack_require__(36);
const GripArrayRep = __webpack_require__(105);
const GripMap = __webpack_require__(107);
const GripMapEntryRep = __webpack_require__(108);
const ErrorRep = __webpack_require__(104);
const { isLongString } = __webpack_require__(23);
