...
describe("TelemetryFeed", () => {
  ...
  describe("#handleASRouterUserEvent", () => {
    ...
    it("should console.error and not submit pings on unknown pingTypes", async () => {
      ...
      sandbox.spy(GleanPings.asRouterNoId, "submit");
      ...
      assert.notCalled(GleanPings.asRouterNoId.submit);
    });
    ...
    it("should submit a Glean ping on known pingType", async () => {
      ...
      assert.calledOnce(GleanPings.asRouterNoId.submit);
    });
    // Additional cases to cover:
    // * GleanPings.asRouter (with the id)
